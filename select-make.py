...
#print(subprocess.getoutput("echo '' > ./select-server.sh"))

#print(subprocess.getoutput("""echo 'dialog --title "Select a Number, IP:"""+proxmox+""" " --menu "Choose A Machine To Connect To:" 1920 1080 1080 \' >> ./select-server.sh"""))
